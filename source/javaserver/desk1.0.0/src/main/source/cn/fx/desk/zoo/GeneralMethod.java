...
public class GeneralMethod {
	...
	public static String getDataFromUrl(String urlStr,String method,String charsetName){
		...
		if(charsetName == null){
			charsetName = DeskConstant.CHARSET_DEFAULT;
		}
	...
	public static JSONObject getJsonFromUrl(String urlStr,String method){
		String data = getDataFromUrl(urlStr, method,DeskConstant.CHARSET_DEFAULT);
		try {
...
//		getResponseBodyAsStream
		...
		BufferedReader br = new BufferedReader(new InputStreamReader(is,DeskConstant.CHARSET_DEFAULT));
